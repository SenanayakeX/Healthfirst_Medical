...
<div class="d1">
	<a href="#">
		<input type="button" name="createSchedule" value="Create Schedule" class="button1">
	</a>
	<br>
	<a href="#">
		<input type="button" name="viewSchedule" value="View Schedule" class="button1">
	</a>
	<br>
	<a href="#">
		<input type="button" name="generateReport" value="Generate Report" class="button1">
	</a>
	<br>
	<a href="#">
		<input type="button" name="viewPaymentInfo" value="View Payment info" class="button1">
	</a>
	<br>
	<a href="CrDiagnostic.jsp">
		<input type="button" name="createDiagnosticReport" value="Create Diagnostic Report" class="button1">
	</a>
</div>
