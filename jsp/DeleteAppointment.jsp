...
<br><br><br>	
	<form action="deleted" method="post">
		...
		<b>Status</b>	<input type="text" name="status" value="<%= status %>" readonly><br>
		<b>Payment</b>	<input type="text" name="payment" value="<%= payment %>" readonly><br>

	
	<input type="submit" name="submit" value="Delete appointment" class="button">
