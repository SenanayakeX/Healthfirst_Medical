...
<br><br><br><br><br>	
	<form action="delete" method="post">
		...
		<b>Email</b><input type="text" name="email" value="<%= email %>" readonly><br>
		<b>Mobile</b><input type="text" name="mobile" value="<%= mobile %>" readonly><br>
		<b>Specialization</b><input type="text" name="special" value="<%= special %>" readonly><br>
		<b>Password</b><input type="text" name="pwd" value="<%= pwd %>" readonly><br>
		<b>Confirmed password</b><input type="text" name="cnfrmpwd" value="<%= cnfrmpwd %>" readonly><br>

	
	<input type="submit" name="submit" value="Delete my profile" class="button">
