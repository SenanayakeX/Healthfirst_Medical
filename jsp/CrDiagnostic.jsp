...
<br>
	...
	<b>PatientID</b> <input type="text" name="pid" ><br>
	<b>Name</b> <input type="text" name="name" ><br>
	<b>Age</b> <input type="text" name="age" ><br>
	<b>Diagnostics</b> <input type="text" name="diag" ><br>
	<b>Prescription</b> <input type="text" name="pres" ><br>
	
	 
	<input type="submit" name="submit" value="Create report" class="button">
